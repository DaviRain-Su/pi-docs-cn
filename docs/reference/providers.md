...
**通过扩展：** 对于需要自定义 API 实现或 OAuth 流程的 provider，创建扩展。见 [custom-provider.md](custom-provider.md) 和 [examples/extensions/custom-provider-gitlab-duo.md](/examples/extensions/custom-provider-gitlab-duo.md)。
