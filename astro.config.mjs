      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: '多链架构', link: '/blockchain/03-dagent/03-architecture/25-dagent-multi-chain/' },
            { label: 'ERC-8004', link: '/blockchain/03-dagent/03-architecture/26-dagent-erc8004-agents/' },
            { label: 'Worker部署', link: '/blockchain/03-dagent/03-architecture/35-dagent-worker-deployment/' },
            { label: '计算平台', link: '/blockchain/03-dagent/03-architecture/36-decentralized-compute/' },
            ...
            { label: '部署对比', link: '/blockchain/03-dagent/05-analysis/34-cloudflare-vs-decentralized/' },
          ],
        },
      ],
